...
<body>
    <a href="https://helpdesk.ca/contact" class="github-corner" aria-label="View source on Github">
        <svg width="80" height="80" viewBox="0 0 250 250" style="fill:#44c0f0; color:#fff; position: absolute; top: 0; border: 0; right: 0;" aria-hidden="true">
            <!-- GitHub SVG content -->
        </svg>
    </a>
    <div class="container">
                    ...
                    <div class="info">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>This query attempts to do a request for all of the available DNS information for the specified hostname. This is not always successful as some providers block the queries</td>
                            </tr>
                            <tr>
